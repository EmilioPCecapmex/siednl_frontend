    ...
    axios
      .post(
        "http://10.200.4.200:5000/api/create-solicitud",
        {
          ...
          Telefono: telephone,
          Extencion: ext,
          DatosAdicionales: JSON.stringify(da) "Tipo de Usuario: "+dataUser.Rol+", Id Tipo de Usuario: "+dataUser.IdRol+", Cargo: "+dataUser.Cargo+", Institucion: "+dataUser.IdInstitucion,
