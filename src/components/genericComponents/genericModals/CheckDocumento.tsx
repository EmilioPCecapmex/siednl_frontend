...
const checkFT = (v: string, FT: string) => {
    errores = [];
    ...
    /////////////////////////////////////////////////////////////////////7
    checkComponentesFT(v, FT);
  };

  const checkComponentesFT = (v: string, FT: string) => {
    ...
    checkActividadesFT(v, FT);
  };

  const checkActividadesFT = (v: string, FT: string) => {
    // eslint-disable-next-line array-callback-return
