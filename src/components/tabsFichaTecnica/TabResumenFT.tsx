...
import { IActividadesMA, IComponenteMA, ICValorMA } from "../tabsMetaAnual/Interfaces";
import { IActividadesEditMA, IComponenteEditMA, IFinEditMA, IPropositoEditMA } from "../tabsMetaAnual/TabResumenMA";
