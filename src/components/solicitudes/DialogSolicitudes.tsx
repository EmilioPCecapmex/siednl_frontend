...
export const DialogSolicitudes = ({
  ...
  const getSolicitudes = () => {
    axios
      .get(
        process.env.REACT_APP_APPLICATION_QA_LOGIN + "/api/solicitudes-app",
        {
          params: {
  ...
  }, [selectedIndex, solicitudSeleccionada]);
                  ...
                  >
                    ...
                    >
                      ...
                      <Select
                        ...
                        onChange={(c) => {
                          filtroXApp(parseInt(c.target.value.toString()));
                        }}
                      >
                        {filtros.map((item, x) => {
                          return (
                      ...
                      {solicitudesFiltered?.map((item, x) => {
                        return (
                          <Box key={x}>
                            <ListItemButton
                              key={x}
                              onClick={() => {itemSelected(x, item.Id);
                              }}
                              sx={{
                                pl: 2,
                                "&.Mui-selected ": {
                        ...
                        {selectedIndex < 0 ? (
                          ...
                          >
                            ...
                            <Typography
                              sx={{ fontFamily: "MontserratSemiBold" }}
                            >
                              Seleccione un registro para visualizar la
                              información
                            </Typography>
                          </Box>
                        ) : (
                            ...
                            >
                              ...
                              >
                                ...
                                <TextField
                                  ...
                                  value={
                                    detalleSolicitud[0]?.NombreSolicitante || ""
                                  }
                                  variant="standard"
                                />
                                <TextField
                              ...
                              >
                                ...
                                <TextField
                                  ...
                                  value={
                                    detalleSolicitud[0]?.ApellidoMaterno || ""
                                  }
                                  variant="standard"
                                />
                              </Box>
                              ...
                              >
                                <TextField
                                  ...
                                  value={
                                    detalleSolicitud[0]?.NombreUsuario || ""
                                  }
                                  variant="standard"
                                />
                                <TextField
                              ...
                              >
                                <TextField
                                  ...
                                  value={
                                    detalleSolicitud[0]?.DatosAdicionales || ""
                                  }
                                  variant="filled"
                                />
                              </Box>
